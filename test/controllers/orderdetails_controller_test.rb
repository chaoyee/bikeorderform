...
class OrderdetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderdetail" do
    assert_difference('Orderdetail.count') do
      post orderdetails_url, params: { orderdetail: { color_id: @orderdetail.color_id, model_id: @orderdetail.model_id, order_id: @orderdetail.order_id, price: @orderdetail.price, quantity: @orderdetail.quantity, size_id: @orderdetail.size_id } }
    end
  ...
  test "should update orderdetail" do
    patch orderdetail_url(@orderdetail), params: { orderdetail: { color_id: @orderdetail.color_id, model_id: @orderdetail.model_id, order_id: @orderdetail.order_id, price: @orderdetail.price, quantity: @orderdetail.quantity, size_id: @orderdetail.size_id } }
